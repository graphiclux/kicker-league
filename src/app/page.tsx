...
// Outer wrapper: just provides Suspense
export default function HomePage() {
  return (
    <Suspense
      fallback={
        <main className="min-h-screen bg-gradient-to-b from-lime-50 to-white text-slate-900 flex items-center justify-center">
...
// Inner component: uses hooks, searchParams, etc.
function HomeInner() {
